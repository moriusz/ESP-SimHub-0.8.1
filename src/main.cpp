...
#define WIFI_SSID "d_test"
#define WIFI_PASSWORD "apococito"
#endif

#define BRIDGE_PORT 33333 // Perle TruePort uses port 10,001 for the first serial routed to the client
#define DEBUG_TCP_BRIDGE 0 // emits extra events to Serial that show network communication, set to false to save memory and make faster
...
#define VERSION 'j'
#ifdef ESP32
	#define DEVICE_NAME "HellodEsp32" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#else
	#define DEVICE_NAME "HellodEsp8266" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#endif
// Known working features:
//  
//#define INCLUDE_TM1638                      //{"Name":"INCLUDE_TM1638","Type":"autodefine","Condition":"[TM1638_ENABLEDMODULES]>0"}
#define INCLUDE_NEOPIXELBUS					//neo pixel bus lib for APA106, SK6812, WS2811, WS2812 and WS2813 RGB like Lpd8806, APA102 and SK9822 
//#define INCLUDE_NEOPIXELMATRIX
...
#ifdef INCLUDE_NEOPIXELBUS
	#include "neobus.h"
#endif
#ifdef INCLUDE_NEOPIXELMATRIX
	#include "neomatrixbus.h"
#endif
// -------------------------------------------------------------------------------------------------------
// WS2812b RGBLEDS ---------------------------------------------------------------------------------------
...
#define WS2812B_DATAPIN D4  		 //{"Name":"WS2812B_DATAPIN","Title":"Data (DIN) digital pin number","DefaultValue":"6","Type":"pin;WS2812B LEDS DATA","Condition":"WS2812B_RGBLEDCOUNT>0"}
